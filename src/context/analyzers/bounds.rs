...
//     pub fn recurse_internal_calls(&self, ctx: ContextNode, called_contracts: &mut BTreeSet<String>, called_external_fns: &mut BTreeSet<Result<String, GraphError>>, called_fns: &mut BTreeSet<Result<String, GraphError>>, report: &mut ReportBuilder<LocStrSpan>, analyzer: &impl GraphLike) {
...
//                     },
//                 );
//                 self.recurse_internal_calls(*child, called_contracts, called_external_fns, called_fns, report, analyzer);
//             });
//     }
// }

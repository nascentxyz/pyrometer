...
contract Cast {
    ...
    function u_int_conc() public {
        u_int(100);
    }

    function i_nt(int256 x) public {
        ...
        int8 x_int8 = int8(x);
        int8 x_int256 = int256(x_int8);
    }

    function i_nt_conc_pos() public {
        i_nt(100);
    }

    function i_nt_conc_neg() public {
        i_nt(-100);
    }

    function u_i_nt(int256 x) public {
        ...
        uint8 x_uint8 = uint8(x);
        int8 x_int8 = int8(x);
        x_uint256 = uint256(x_int8);
    }

    function b_ytes(bytes32 x) public {
    ...
    function b_ytes_uint(bytes32 x) public returns (uint256) {
        uint256 x_uint256 = uint256(x);
        return x_uint256;
    }

    function u_int_bytes(uint256 x) public returns (bytes32) {
    ...
    function b_ytes_uint_conc() public returns (bytes32) {
        bytes32 round_trip = u_int_bytes(b_ytes_uint(hex"1337"));
        require(round_trip == bytes32(hex"1337"));
        return round_trip;
    }

    function addr_uint_conc() public returns (address) {
...
contract FuncCast {
    function a(bytes32 vs) public {
        b(vs);
    }
    function b(bytes32 vs) public {

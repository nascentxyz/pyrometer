contract RequireWithKilled {
    ...
    function andShortCircuit() public {
        ...
        require((bumpCountIfValueEq1ThenReturn(1, false) && bumpCountIfValueEq1ThenReturn(1, true)) || true);
    ...
    function andFullCircuit() public {
        ...
        require(bumpCountIfValueEq1ThenReturn(1, true) && bumpCountIfValueEq1ThenReturn(1, true));
    ...
    function orShortCircuitRHS() public {
        count = 0;
        // ( bump(true) || bump(true) ) , this will test that the second bump is not evaluated since the `or` short circuits
        require(bumpCountIfValueEq1ThenReturn(2, true) || bumpCountIfValueEq1ThenReturn(1, true));
    ...
    function yulAndFullCircuit() public {
        ...
        assembly {
            ...
            if or(bumpCountIfValueEq1ThenReturn(1, true), bumpCountIfValueEq1ThenReturn(0, true)) {}
        }
        "pyro::variable::count::range::[2, 2]";
    }
    ...
    function orFullCircuit() public {
        ...
        require(bumpCountIfValueEq1ThenReturn(1, false) || bumpCountIfValueEq1ThenReturn(1, true));
        "pyro::variable::count::range::[2, 2]";
    }

    function bumpCountIfValueEq1ThenReturn(uint8 x, bool returnValue) internal returns (bool) {
        if (x == 1) {
            count += 1;
        }
        return returnValue;

...
contract Intrinsics {
    function strConcat() public pure {
        string memory a = "aa";
        string memory b = "bb";
    ...
    function bytesConcat() public pure {
    ...
    function blockData() public view {
    ...
    function msgData() public payable {
    ...
    function asserting() public pure {
        assert(true);
    }

    function requiring() public pure {
    ...
    function precompiles() public pure {
        bytes memory a = hex"aa";
    ...
    function typeAttrs() public pure {
    ...
    function uintMinMax() public pure {
    ...
    function addressAttrs(address payable x, address y) public {
        ...
        bool result = payable(tester).send(1);
        result;
        codehash;
        code;
        bal;
        payable(tester).transfer(1);
        (bool r, bytes memory d) = x.call("");
        (r, d) = y.call("");
        (r, d) = x.delegatecall("");
        (r, d) = y.delegatecall("");
        (r, d) = x.staticcall("");
